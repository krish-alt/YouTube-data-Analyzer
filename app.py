...
API_KEY = 'AIzaSyC-ROh7dKxnJr-pt3uak9COy3RAJiLanAQ'

app = Flask(__name__)

@app.route('/')
def home():
    return render_template('layout.html')  #first window 
...
def video_comments():
    ...
    like_count_sentiment_corr = comment_sentiment2.corr().loc['like_count'][5]
